...
-- Step 3 - Score the model- In this step, you will invoke the stored procedure predict_cdr_churn_mx_fasttree
-- The stored procedure uses the mxPredict function to predict the customers that are likely to churn
