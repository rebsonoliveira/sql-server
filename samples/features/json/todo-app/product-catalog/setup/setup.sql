...
INSERT INTO Product(ProductID, Name, Color, Size, Price, Quantity, Data)
SELECT ProductID, Name, Color, Size, Price, Quantity, Data
...
AS BEGIN
	...
	INSERT INTO dbo.Product(Name,Color,Size,Price,Quantity,Data)
	OUTPUT  INSERTED.ProductID
	SELECT Name,Color,Size,Price,Quantity,Data
	FROM OPENJSON(@ProductJson)
		WITH (	Name nvarchar(100) N'strict $."Name"',
				...
				Quantity int,
				Data nvarchar(max) AS JSON) as json
END
GO
...
AS BEGIN
	...
	USING ( SELECT Name,Color,Size,Price,Quantity,Data
			FROM OPENJSON(@ProductJson)
				WITH (
	...
	WHEN NOT MATCHED THEN 
		INSERT (Name,Color,Size,Price,Quantity,Data)
		VALUES (json.Name,json.Color,json.Size,json.Price,json.Quantity,json.Data);
END
GO