...
New-AzureRmResourceGroupDeployment -ResourceGroupName $resourceGroupName -TemplateUri ($scriptUrlBase+'/azuredeploy.json'+ [DateTime]::Now.Ticks) -TemplateParameterObject $templateParameters
