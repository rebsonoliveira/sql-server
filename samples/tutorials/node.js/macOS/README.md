# Get started with SQL Server and Node.js on macOS

Get started quickly with developing applications in Node.js on macOS with SQL Server
...
Please visit the [Node.js on macOS tutorial](https://www.microsoft.com/en-us/sql-server/developer-get-started/node-mac) to run through the sample in full with more detail.
